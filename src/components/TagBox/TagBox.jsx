...
// const users = ["john_doe", "jane_smith", "alex99", "monesh_dev"];
...
//     // Detect @ followed by letters
//     const match = value.match(/@(\w*)$/);
//     if (match) {
//       setShowUserList(true);
//       setMentionQuery(match[1]); // what user is typing after @
//     } else {
...
//         <input
//           className="outline-none w-[100%] h-[50%] p-6 text-xl"
//           value={inputValue}
...
//           <ul className="absolute z-10 bg-white border rounded shadow p-1 top-[355px] left-120 w-48">
//             {filteredUsers.map((user) => (
//               <li
//                 key={user}
//                 className="cursor-pointer hover:bg-gray-100 px-4 py-1 rounded-lg"
